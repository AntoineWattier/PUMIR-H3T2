...
INSERT INTO `AMBIANCE` (`id_ambiance`, `slug_ambiance`, `name_ambiance`)
VALUES
	(1,'repas-leger','Repas léger'),
	(2,'repas-romantique','Repas romantique'),
	(3,'saveurs-d-ailleurs','Saveurs d\'ailleurs'),
	(4,'repas-vegetarien','Repas végétarien'),
	(5,'repas-gourmand','Repas gourmand');
